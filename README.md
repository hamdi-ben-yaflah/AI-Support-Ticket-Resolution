...
- Anthropic system-prompt caching behind a validated flag, measured against the golden dataset — see [docs/operations/prompt-caching.md](docs/operations/prompt-caching.md).
